  ...
  switch(count_value)
{
  ...
  //////////////////////////////////////////////////////////////////////////////////
    ...
    case 11:
      ...
      //------------------------------------------------------------------------------
    case 12:
      Resetting(T1_dir, T1_pwm,LOW,10, 2800);   //AKAN RESET THROWER1 UNTUK PEGANG ARROW
      ...
      //------------------------------------------------------------------------------
     case 14:
      Resetting(T1_dir, T1_pwm,HIGH,10, 2800);   //AKAN RESET THROWER2 UNTUK PEGANG ARROW
      ...
      //------------------------------------------------------------------------------
      case 16:
      Resetting(T2_dir, T2_pwm,HIGH,10, 2800);   //AKAN RESET THROWER3 UNTUK PEGANG ARROW
      ...
      //------------------------------------------------------------------------------
      case 18:
      Resetting(T2_dir, T2_pwm,LOW,10, 2800);    //AKAN RESET THROWER4 UNTUK PEGANG ARROW
      ...
      //------------------------------------------------------------------------------
    case 20:
      Resetting(T3_dir, T3_pwm,HIGH,10, 1100);    //AKAN RESET THROWER5 UNTUK PEGANG ARROW
...
{
 myservo.write(0,150,true);  //(degree,speed)
 delay(800);
}

void spin_sikit()
{
  myservo.write(30,200,true);  //(degree,speed)
 delay(800);
}
...
{
 myservo.write(170,200,true);  //(degree,speed)
 delay(800);
}
...
{ 
  ...
  AngleServo.attach(12); // ori 44, PIN 46 no more twitching
...
{
 AngleServo.write(0,150,true);  //(degree,speed)bukak
 delay(800);
}
...
{
 AngleServo.write(50,40,true);  //(degree,speed)tutup
 delay(800);
}
